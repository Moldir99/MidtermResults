...
public class ExpListAdapter2 extends BaseExpandableListAdapter {
    ...
    public ExpListAdapter2(HashMap<String, List<String>> mStringListHashMap) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.exp_list_group2, parent, false);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        if(convertView == null)
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.exp_list_item2,parent, false);
